...
<body>
    ...
    <div class="contentambah">
        <form method="POST" action="proses.php" enctype="multipart/form-data">
            ...
            <input type="text" name="customername" id="customername" placeholder="Masukkan Customer Name"
            ...
            <input type="text" name="contactfirstname" id="contactfirstname" placeholder="Masukkan Contact Last Name"
                value="<?php echo $contactfirstname; ?>">
            <label for="phone">
                phone
            </label>
            <input type="text" name="phone" id="phone" placeholder="Masukkan phone"
                value="<?php echo $phone; ?>">
            <label for="addresline1">
                Addres Line 1
            </label>
            <input type="text" name="addresline1" id="addresline1"
                placeholder="Cth: 8489 Strong St" value="<?php echo $addresline1; ?>">
            <label for="addresline2">
                Addres Line 2
            </label>
            <input type="text" name="addresline2" id="addresline2"
                placeholder="Cth: Suite 400" value="<?php echo $addresline2; ?>">
            <label for="city">
                City
            </label>
            <input type="text" name="city" id="city" placeholder="Cth: Nantes" value="<?php echo $city; ?>">
            <label for="state">
                State
            </label>
            <input type="text" name="state" id="state" placeholder="Cth: NV" value="<?php echo $state; ?>">
            <label for="postalcode">
                Postal Code
            </label>
            <input type="text" name="postalcode" id="postalcode" placeholder="Cth: 44000" value="<?php echo $postalcode; ?>">
            <label for="country">
                Country
            </label>
            <input type="text" name="country" id="country" placeholder="Cth: USA" value="<?php echo $country; ?>">
            <label for="salesrepemployeenumber">
                Sales Rep Employee Number
            </label>
            <input type="text" name="salesrepemployeenumber" id="salesrepemployeenumber" placeholder="Cth: 1370(Harus sesuai dengan employee number yang sudah ada)" value="<?php echo $salesrepemployeenumber; ?>">
            <label for="creditlimit">
                Credit Limit
            </label>
            <input type="text" name="creditlimit" id="creditlimit" placeholder="Cth: 23423.00" value="<?php echo $creditlimit; ?>">
            <?php
            if (isset($_GET['ubah'])) {
                ?>
